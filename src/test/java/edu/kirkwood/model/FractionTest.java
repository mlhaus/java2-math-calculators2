...
class FractionTest {
    ...
    @Test
    void compareToSortsArrayListFromSmallestToLargest() {
        ...
        assertEquals(new Fraction(-1, 4), fractions.get(0));
        assertEquals(new Fraction(0, 1), fractions.get(1));
        assertEquals(new Fraction(1, 2), fractions.get(2));
        assertEquals(new Fraction(3, 4), fractions.get(3));
    }
    ...
    void notEquals() {
        f2 = new Fraction(1, 2);
        assertTrue(!f1.equals(f2), "1/1 != 1/2");
    }
